...
import { Fuel, CircleIcon, Moon, MapPin  } from 'lucide-react';
...
const currentIcon = createIcon('#3182ce', <MapPin size={16} color="white" />);
...
const restIcon = createIcon('#d69e2e', <Moon size={16} color="white" />);
const fuelIcon = createIcon('#805ad5', <Fuel size={16} color="white" />);
